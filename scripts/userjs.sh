...
// Enable RFP and letterboxing
//     - 1600x900 appears to be the default size of a
//       new window when letterboxing is on so I enforce it.
...
// This is supposed to stop firefox.settings.services.mozilla.com but it seems like it doesn't
...
// Disable fullpage translations
user_pref("browser.translations.enable", false);

// Disable DRM nonsense
